...
const PaymentModal = ({ isOpen, onClose, amount, bookingId, seats, fetchBookings, fetchBookingStats, isDark }) => {
  ...
  const handlePayment = async () => {
    try {
      ...
      const { data } = await axios.post(`${import.meta.env.VITE_API_BASE_URL}/payments/create-order/`, {
        amount,
        booking_id: bookingId,
        seats, // send array of seat IDs
      });
        ...
        handler: async function (response) {
          try {
            await axios.post(`${import.meta.env.VITE_API_BASE_URL}/payments/verify/`, {
              ...
              booking_id: bookingId,
              seats, // send seat info for verification if needed
            });
